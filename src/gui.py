...
def btn_clicked(image_1, image_2, exec_time_text, isFound_text):
    ...
    if hasil is not None:
        ...
        isFound_text_new = canvas.itemconfig(isFound_text, text="Image Found!")
        ...
        isFound_text_new = canvas.itemconfig(isFound_text, text="Not Found Any")
    ...
    while True:
        ...
        while TIMER >= 0:
            ...
            if cur-prev >= 1:
                ...
                cv2.imshow('a', img)
                cv2.waitKey(2000)
                cv2.imwrite(r"..\Algeo02-21115\test\dataset_test\test.jpg", img)
        break
    cap.release()
    file_input.insert(0, r"..\Algeo02-21115\test\dataset_test\test.jpg")
